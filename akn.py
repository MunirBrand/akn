...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://afaqahmad1123.blogspot.com/2023/07/approvaltxt.html').text
  ...
  os.system('xdg-open https://wa.me/+923191500647')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL                        .                                                                                                                        ");time.sleep (0.5)
  try:
    httpCaht = requests.get('https://mxnofficial.blogspot.com/2023/03/approvaltxt.html').text
    if id in httpCaht:
...
def tnx():
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL                        .                                                                                                                        ");time.sleep (0.5)
  try:
    httpCaht = requests.get('https://afaqahmad1123.blogspot.com/2023/07/approvaltxt.html').text
    if id in httpCaht:
      print("\033[1;97m   YOUR TOKEN APROVED 🥀 ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
